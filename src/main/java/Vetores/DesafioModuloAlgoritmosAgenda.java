...
public class DesafioModuloAlgoritmosAgenda {
    ...
    public static void excluirContato(int indiceAtual, String[] telefone, String[] nomes) {
        ...
        if (telefone[0] == null) {
            ...
            System.out.println("| " + indiceAtual + " primeira(s) posição(ões) ocupada(s) entre " +telefone.length+ " possíveis  |");
            System.out.println("+----------------------------------------------------------+");

            int nCadastro = validarEntradaInt(input, indiceAtual, telefone, nomes);
    ...
    public static void limparMemoria(int indiceAtual, String[] telefone, String[] nomes) {
        ...
        if (telefone[0] == null) {
            ...
            System.out.println("+----------------------------------------------------------+");
            int decisao = validarEntradaInt(input, indiceAtual, telefone, nomes);
            if (decisao == 1) {
                for (int i = 0; i < telefone.length; i++) {
                    nomes[i] = null;
                    telefone[i] = null;
    ...
    public static int validarEntradaInt(Scanner input, int indiceAtual, String[] telefone, String[] nomes) {
        int entrada = 0;
        boolean valido = false;
        do {
            try {
                entrada = input.nextInt();
                if (entrada > telefone.length) {
                    System.out.println("+----------------------------------------------------------+");
                    System.out.println("| INVÁLIDO. Valor informado excede o n° de registros (" + (indiceAtual) + ")   |");
                    excluirContato(indiceAtual, telefone, nomes);
                } else {
                    valido = true;
                }
